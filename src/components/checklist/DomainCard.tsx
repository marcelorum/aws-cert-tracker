...
export function DomainCard({ domain }: DomainCardProps) {
  ...
  return (
    ...
    >
      <Collapsible.Trigger className="w-full flex items-center gap-3 px-4 py-3 bg-white hover:bg-gray-50 transition-colors text-left dark:bg-gray-900 dark:hover:bg-gray-800">
      ...
      <Collapsible.Content>
        <div className="border-t border-gray-100 dark:border-gray-800 divide-y divide-gray-50 dark:divide-gray-800">
          {topics.length === 0 && (
            <p className="px-4 py-3 text-sm text-gray-400 dark:text-gray-500">No topics yet.</p>
          )}
          {topics.map((topic) => {
            ...
            return (
              <div key={topic.id}>
                ...
                {subTopics.length > 0 && (
                  ...
                  >
                    <Collapsible.Content>
                      <div className="ml-8 border-l border-gray-100 dark:border-gray-800 pl-4 divide-y divide-gray-50 dark:divide-gray-800">
                        {subTopics.map((st) => (
